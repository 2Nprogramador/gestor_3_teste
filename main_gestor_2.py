...
@st.cache_data
def calcular_estoque_atualizado(vendas_df, registro_estoque_df):
...
def visualizar_dados():
    ...
    st.dataframe(st.session_state.registro_estoque_df)
    ...
    produto_mais_vendido = st.session_state.vendas_df.groupby("Produto")["Quantidade"].sum().idxmax()
